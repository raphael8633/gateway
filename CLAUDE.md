...
Auto-generated by `gen-service-registry.py` from `../README.md` (project metadata) joined with `Caddyfile` (ports). Edit those two files, not this table.
...
| `/public` | 8020 | public-share | WSGI |
| `/vpn` | 8011 | vps2-vpn | FastAPI |
| `/health` | 3002 | health-manage | Next.js |
| `/task-hub` | 3003 | task-hub | Next.js |
| `/auth-admin` | 5000 | global-auth | Authelia |
| `/hermes-webui` | 8877 | hermes-webui | Python |
| `/tao-conviction` | 3006 | subtensor-hub | Next.js |
| `/tao-research` | 8040 | subtensor-hub | Next.js |
| `/reader/` | 5174 | raph-reader | React |
| `/tools/` | 5175 | raph-tools | Fastify |

<!-- END:SERVICE_REGISTRY -->

Whether a route is auth-protected lives in `Caddyfile` (search for `import proxy_auth`); not duplicated here.
